...
export default {
    name: 'helpadmin',
    description: 'Menu Bantuan khusus untuk para Administrator Bot!',
    async execute(message: Message, args: string[]) {
        // Prevent ordinary members from viewing this
        if (!message.member?.permissions.has(PermissionFlagsBits.Administrator)) {
            return message.reply('❌ Kamu bukan admin, kamu tidak bisa melihat menu ini!');
        }
